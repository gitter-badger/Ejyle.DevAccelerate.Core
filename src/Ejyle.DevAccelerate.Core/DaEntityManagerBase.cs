...
namespace Ejyle.DevAccelerate.Core
{
    ...
    public class DaEntityManagerBase<TKey, TEntity, TEntityRepository> : IDaEntityManager<TKey, TEntity, TEntityRepository>
        ...
        where TEntityRepository : IDaEntityRepository<TKey, TEntity>
    {
        ...
        public DaEntityManagerBase(TEntityRepository repository)
        {
            if(repository == null)
            {
